...
for (const type of types) {
    asset_api_helper_1.test(`Update Owners relational Attribute on single Story, adding and removing owners with object context pointing to arrays by OIDToken (${type})`, async (t) => {
        const setupCommand = `
from: Story
where:
...
//# sourceMappingURL=update_Owners_relational_Attribute_on_single_Story_adding_and_removing_owners_with_object_context_pointing_to_arrays_by_OIDToken.js.map