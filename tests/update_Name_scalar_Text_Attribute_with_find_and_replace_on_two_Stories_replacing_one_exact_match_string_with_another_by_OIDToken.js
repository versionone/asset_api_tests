...
for (const type of types) {
    asset_api_helper_1.test(`Update Name Text scalar Attribute on two Stories, replacing one exact match string with another by OIDToken (${type})`, async (t) => {
        const setupCommand = `
AssetType: Scope
...
//# sourceMappingURL=update_Name_scalar_Text_Attribute_with_find_and_replace_on_two_Stories_replacing_one_exact_match_string_with_another_by_OIDToken.js.map