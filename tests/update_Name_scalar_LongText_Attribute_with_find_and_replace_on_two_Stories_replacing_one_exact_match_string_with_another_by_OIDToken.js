...
for (const type of types) {
    asset_api_helper_1.test(`Update Name LongText scalar Attribute on two Stories, replacing one exact match string with another by OIDToken (${type})`, async (t) => {
        const setupCommand = `
AssetType: Scope
Name: Test - Update Name LongText scalar Attribute on two Stories with find and replace Scope
Parent: Scope:0
...
//# sourceMappingURL=update_Name_scalar_LongText_Attribute_with_find_and_replace_on_two_Stories_replacing_one_exact_match_string_with_another_by_OIDToken.js.map